...
from quaqsim.architectures.transmon_pair_backend_from_qua import TransmonPairBackendFromQUA, \
    ConfigToTransmonPairBackendMap
from quaqsim.architectures.from_qua_channels import TransmonPairBackendChannelReadout, \
