...
from quaqsim.program_to_quantum_pulse_sim_compiler.schedules.timeline_base import TimelineBase
from quaqsim.program_to_quantum_pulse_sim_compiler.schedules.timeline_builder import \
    TimelineBuilder
...
class TimelineSingleBase(TimelineBase):
    ...
    #     from quaqsim.program_to_quantum_pulse_sim_compiler.schedules.simultaneous import \
    #         Simultaneous
...
class TimelineSingle(TimelineSingleBase, TimelineBuilder):
    ...
    def reset_phase(self):
        from quaqsim.program_to_quantum_pulse_sim_compiler.schedules.reset_phase import \
            ResetPhase
    ...
    def phase_offset(self, phase: float):
        from quaqsim.program_to_quantum_pulse_sim_compiler.schedules.phase_offset import \
            PhaseOffset
